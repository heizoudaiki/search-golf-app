      ...
      <div className="Search__Form">
        <form className="ui form segment" onSubmit={onFormSubmit}>
          ...
          <div className="field">
            ...
            <select className="ui dropdown" name="dropdown" value={budget} onChange={e => setBudget(Number(e.target.value))}>
          ...
          <div className="field">
            ...
            <select className="ui dropdown" name="dropdown" value={departure} onChange={e => setDeparture(Number(e.target.value))}>
          ...
          <div className="field">
            ...
            <select className="ui dropdown" name="dropdown" value={duration} onChange={e => setDuration(Number(e.target.value))}>
